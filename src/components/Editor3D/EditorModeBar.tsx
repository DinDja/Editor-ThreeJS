...
import { Boxes, Database, Download, Grid3X3, Monitor, MousePointer2 } from 'lucide-react';
...
export default function EditorModeBar() {
  ...
  return (
    <nav data-tutorial="mode-bar" className="flex h-10 shrink-0 items-center gap-1 overflow-x-auto border-b border-neutral-800 bg-[#131517] px-2">
      {modes.map((mode) => (
        <button
          key={mode.id}
          type="button"
