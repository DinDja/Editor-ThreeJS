...
export const EFFECT_REGISTRY: Record<EffectType, EffectDefinition> = {
  ...
  customCursor: {
    ...
    description: 'Cursor customizado com Cursorly.js — ícone e efeitos de partículas.',
    renderer: 'css',
    cost: 'low',
    category: 'interactive',
    props: [
      { key: 'iconIndex', label: 'Ícone do Cursor', type: 'range', min: 0, max: 41, step: 1, default: 0 },
      { key: 'effect', label: 'Efeito Visual', type: 'select', default: 'trail', options: [
        { value: 'none', label: 'Nenhum' },
        { value: 'trail', label: 'Trilha' },
        { value: 'sparkle', label: 'Brilho' },
        { value: 'neonGlow', label: 'Neon Glow' },
        { value: 'fireworks', label: 'Fogos' },
        { value: 'snowfall', label: 'Neve' },
        { value: 'aura', label: 'Aura' },
        { value: 'comet', label: 'Cometa' },
      ] },
      { key: 'effectColor', label: 'Cor do Efeito', type: 'color', default: '#ffffff' },
      { key: 'cursorSize', label: 'Tamanho (px)', type: 'range', min: 16, max: 64, step: 2, default: 32 },
    ],
  },
  scrollReveal: {
    type: 'scrollReveal',
