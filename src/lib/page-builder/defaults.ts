...
import type { PageDocument, PageNode, PageNodeType, PageStyle, ProjectSettings, ResponsiveStyles } from './types';
...
export const createDefaultPageDocument = (): PageDocument => {
  ...
  return {
    ...
    type: 'page',
    name: 'Page',
    children: [navbar, hero, features, createPageNode('footer')],
    responsive: {
      desktop: 1280,
      tablet: 820,
      mobile: 390,
